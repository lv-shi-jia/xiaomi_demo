<template>
    <div class="shopping" v-if="ars.length!=0">
        <div class="header">
            <van-nav-bar title="购物车" left-text="返回" left-arrow style="background:#f2f2f2" @click-left="go">
        ...
        computed:{
            count(){
                return this.arr.reduce((pre,next)=>{
                    localStorage.setItem("key",pre+next.value)
